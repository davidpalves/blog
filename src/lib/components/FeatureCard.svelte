...
<a
	class='w-full transform rounded-xl bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-400 p-1 transition-all hover:scale-[1.01] md:w-1/3 hover:no-underline'
	{href}
	sveltekit:prefetch
>
